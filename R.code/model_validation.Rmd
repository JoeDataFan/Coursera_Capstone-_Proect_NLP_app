...
predict_next_word <- function(prev.words, model = ng.model.clean){
...
saveRDS(valid.hexagram.base, file = "./data/temp.data/valid.hexagram.base.rds")
saveRDS(valid.hexagram.base, file = "./data/temp.data/valid.hexagram.pred.rds")
getwd()
```
```{r Evaluate model}
