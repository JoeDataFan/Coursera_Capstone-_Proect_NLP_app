...
### Performance
From 2000 tests (using text never seen by the model)
...
shinyApp(
    ui = fluidPage(
        ...
        # instructions
        h3('Type in the box below and the next word will be predicted. Click ENTER to combine into a sentence.'),
    ...
    server = function(input, output, session) {
            ...
            observe({
                ...
                textData <- reactive({
                    ...
                    data <- data.table(returned.text = c(trimws(data)))
                })
