...
# vector.
# todo:
# apply to all sample.text
# create and unlist unigram, bigram, trigram, tetragram, pentagram
# convert to data table
# split into base and predict words
# determine frequencies for each base / predict word pair

corpus.test <- corpus(sample.text)
corpus.test.sentences <- tokens(corpus.test,
                                what = "sentence",
                                include_docvars = FALSE) 
corpus.test.unigram <- tokens(corpus.test, what = "word",
                              remove_numbers = TRUE,
                              remove_punct = TRUE,
                              remove_symbols = TRUE,
...
corpus.test.bigram <- tokens(sample.blogs, what = "word",
                              remove_numbers = TRUE,
                              remove_punct = TRUE,
                              remove_symbols = TRUE,
                              remove_separators = TRUE,
...
- tokenize sentences to account for start and end of sentences