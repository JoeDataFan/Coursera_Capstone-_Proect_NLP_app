...
blogs.trigram <- create_ngrams(corpus = corpus.blogs.sentences, ngrams = 3L)
blogs.quadgram <- create_ngrams(corpus = corpus.blogs.sentences, ngrams = 4L)
blogs.pentagram <- create_ngrams(corpus = corpus.blogs.sentences, ngrams = 5L)
...
blogs.bigram.freq <- split_base_pred_freq(ngram = blogs.bigram)
blogs.trigram.freq <- split_base_pred_freq(ngram = blogs.trigram)
blogs.quadgram.freq <- split_base_pred_freq(ngram = blogs.bigram)
blogs.pentagram.freq <- split_base_pred_freq(ngram = blogs.bigram)



# determine counts of unigue prediction words by base word
# return max count for each base (MLE prediction word)
bigram.base.pred.freq <- base_pred_freq(dt = bigram.base.pred)
