...
sample.blogs <- read.delim("../data/temp.data/sample.blogs.txt",
                                 sep = "\n",
                                 header = FALSE,
                                 stringsAsFactors = FALSE)
# load news data sample
sample.news <- read.delim("../data/temp.data/sample.news.txt",
                            sep = "\n",
                            header = FALSE,
                            stringsAsFactors = FALSE)
# load twitter data sample
sample.twitter <- read.delim("../data/temp.data/sample.twitter.txt",
                            sep = "\n",
                            header = FALSE,
                            stringsAsFactors = FALSE)
